...
import { idlFactory } from './auth-test.did.js';
export { idlFactory } from './auth-test.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AUTH_TEST;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./auth-test.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the auth-test canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./auth-test.did.js")._SERVICE>}
 */
export const auth_test = createActor(canisterId);
