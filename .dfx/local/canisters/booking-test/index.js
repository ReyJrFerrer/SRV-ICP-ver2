...
import { idlFactory } from './booking-test.did.js';
export { idlFactory } from './booking-test.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BOOKING_TEST;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./booking-test.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the booking-test canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./booking-test.did.js")._SERVICE>}
 */
export const booking_test = createActor(canisterId);
