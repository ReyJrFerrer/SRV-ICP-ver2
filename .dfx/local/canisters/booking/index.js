...
export const canisterId = process.env.CANISTER_ID_BOOKING;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./booking.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the booking canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./booking.did.js")._SERVICE>}
 */
