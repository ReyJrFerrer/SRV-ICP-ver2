...
import { idlFactory } from './reputation-test.did.js';
export { idlFactory } from './reputation-test.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REPUTATION_TEST;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./reputation-test.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the reputation-test canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./reputation-test.did.js")._SERVICE>}
 */
export const reputation_test = createActor(canisterId);
