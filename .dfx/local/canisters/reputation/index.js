...
import { idlFactory } from './reputation.did.js';
export { idlFactory } from './reputation.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REPUTATION;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./reputation.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the reputation canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./reputation.did.js")._SERVICE>}
 */
export const reputation = createActor(canisterId);
