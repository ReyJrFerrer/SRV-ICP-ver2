...
import { idlFactory } from './review-test.did.js';
export { idlFactory } from './review-test.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REVIEW_TEST;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./review-test.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the review-test canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./review-test.did.js")._SERVICE>}
 */
export const review_test = createActor(canisterId);
