...
export const canisterId = process.env.CANISTER_ID_REVIEW;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./review.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the review canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./review.did.js")._SERVICE>}
 */
