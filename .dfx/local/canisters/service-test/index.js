...
import { idlFactory } from './service-test.did.js';
export { idlFactory } from './service-test.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SERVICE_TEST;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./service-test.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the service-test canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./service-test.did.js")._SERVICE>}
 */
export const service_test = createActor(canisterId);
