...
import styles from 'frontend/ui/components/client/ClientBookingConfirmationPage.module.css'; // Adjust if your path is different
        ...
        {bookingDetails ? (
          <div className={styles.confirmationCard}>
            ...
            <div className={styles.detailsSection}>
              ...
              <p><strong>Service:</strong> {bookingDetails.serviceName} (Provider: {bookingDetails.providerName})</p>
          ...
          <div className={styles.confirmationCard}>
            <p>Loading booking details or an error occurred while parsing details.</p>
            <Link href="/client" legacyBehavior>
              <a className={styles.homeButton}>Back to Home</a>
            </Link>
          </div>
