...
const ServiceManagementNextjs: React.FC<ServiceManagementProps> = ({
  ...
  if (loading) {
    return (
      // Added a Fragment to hold the heading and the div
      <>
        <h2 className="pt-4 text-4xl font-extrabold text-black mb-6">
          My Services
        </h2>
        <div
          className={`services-section p-6 rounded-xl shadow-lg ${className}`}
        >
  ...
  if (error) {
    return (
      // Added a Fragment to hold the heading and the div
      <>
        <h2 className="pt-5 text-3xl font-extrabold text-black mb-6">
          My Services
        </h2>
        <div
          className={`services-section  p-6 rounded-xl shadow-lg ${className}`}
    ...
    <>
      ...
      <div className="flex justify-between items-center mb-6 pt-5">
        ...
        <Link href="/provider/services/add" legacyBehavior>
          <a
            className="add-button px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors flex items-center space-x-2"
      ...
      <div
        className={`services-section p-6 rounded-xl shadow-lg ${className} mt-4`}
      >
