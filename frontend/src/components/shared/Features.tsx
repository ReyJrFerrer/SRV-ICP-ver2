 ...
 export default function Features() {
   return (
     <section className="py-16 lg:py-24 bg-white"> {/* White background */}
       <div className="container mx-auto px-6">
         <div className="text-center mb-12 lg:mb-16">
           <h1 className="text-4xl lg:text-5xl font-bold text-slate-800 mb-6">How does SRV work?</h1> 
         </div>
         
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
           {features.map((feature, index) => (
             <div key={index} className="bg-yellow-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col items-center text-center">
