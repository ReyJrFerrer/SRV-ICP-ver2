...
            )} */}
            <div className="p-6">
              <div className="flex justify-between items-start mb-2">
                ...
                <span
                  className={`px-3 py-1 text-xs font-semibold rounded-full ml-2 flex-shrink-0 bg-${getStatusColor(
                    service.status
...
                  )} */}
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link
                href={`/provider/services/${service.id}/packages/add`}
                legacyBehavior
              >
                <a className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg text-sm transition-colors flex-shrink-0">
                  Add Service Package
                </a>
              </Link>
            </div>
...
          )} */}
          ...
          <div className="container mx-auto flex flex-col space-y-2">
            <Link href={`/provider/services/edit/${service.id}`} legacyBehavior>
              <a className="w-full text-center py-3 bg-white text-gray-700 border border-gray-300 rounded-lg font-semibold hover:bg-gray-50 transition-colors shadow-sm">
                Edit Service
              </a>
            </Link>
            <button
              ...
              className="w-full py-3 bg-white text-gray-700 border border-gray-300 rounded-lg font-semibold hover:bg-gray-50 transition-colors shadow-sm disabled:opacity-50"
            >
              Deactivate
            </button>
            <button
              ...
              disabled={isDeleting}
              className="w-full py-3 bg-white text-red-500 border border-gray-300 rounded-lg font-semibold hover:bg-gray-50 transition-colors shadow-sm disabled:opacity-50"
            >
              Delete Service
            </button>
          </div>
